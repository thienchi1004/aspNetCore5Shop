...
namespace WebBanHang.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Image,Published,Tittle,MetaDesc,MetaKey,Alias,CreateAt,Ordering")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PageId,PageName,Contents,Image,Published,Tittle,MetaDesc,MetaKey,Alias,CreateAt,Ordering")] Page page)
        {
            if (id != page.PageId)
            {
                return NotFound();
